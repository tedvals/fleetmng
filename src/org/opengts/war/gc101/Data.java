    ...
    extends CommonServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        if (isPost) {
            ...
            if (cmd.equalsIgnoreCase("version") || 
                ...
                out.println("OK:version:"+DEVICE_CODE+"-"+VERSION);
                return;
            }
        }
        ...
        /* parse/insert event */
        try {
            this.parseInsertEvent(ipAddr, imei, gprmc, code);
        } catch (Throwable t) {
    ...
    private boolean parseInsertEvent(String ipAddr, String imei, String gprmc, String code)
    {
