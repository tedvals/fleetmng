            ...
            if (SubmitMatch(submit,i18n.getString("ChangePassword.change","Change"))) {
                ...
                if (user != null) {
                    ...
                    if (!pwdHandler.validateNewPassword(pwdNew1)) {
                        m = i18n.getString("ChangePassword.invalidUserFormat","Password must have the following attributes: {0}", 
                    ...
                    if (!pwdHandler.validateNewPassword(pwdNew1)) {
                        m = i18n.getString("ChangePassword.invalidAcctFormat","Password must have the following attributes: {0}", 
                            pwdHandler.getPasswordFormatDescription(locale));
                        error = true;
                    } else {
