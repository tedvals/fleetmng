    ...
    implements Constants
{
        ...
        throws ServletException, IOException
    {
        ...
        if (!StringTools.isBlank(encpass)) {
            ...
            encodedPassword = Account.encodePassword(privLabel,password); // may be null, if password is null
        ...
        try {
            ...
            if (loginOK && !wasLoggedIn) {
                String decodedPassword = Account.decodePassword(privLabel,encodedPassword);
                if (user != null) {
