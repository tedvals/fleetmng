    ...
    extends JSMap
{
    ...
    public  static final String PROP_MAPQUEST_showArialLayer[]  = new String[] { "mapQuest.enableLayer.arial" };
        ...
        throws IOException
    {
        ...
        boolean mqArialLayer = rtp.getBoolean(PROP_MAPQUEST_showArialLayer,false); 
        JavaScriptTools.writeJSVar(out, "MAPQUEST_showOSMLayer"  , mqOsmLayer);
        JavaScriptTools.writeJSVar(out, "MAPQUEST_showArialLayer", mqArialLayer);
    }
