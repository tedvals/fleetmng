...
// OBC/J1708 status: 0xF900 to 0xF9FF
    ...
    // Description:
    //      Excessive deceleration detected
...
// ----------------------------------------------------------------------------
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_PERSON_ENTER       , "PERSON.EMBARK", I18N.getString(StatusCodes.class,"StatusCodes.personEmbark"    ,"Person Embark"   ), true ),
        new Code(STATUS_PERSON_EXIT        , "PERSON.DISEMB", I18N.getString(StatusCodes.class,"StatusCodes.personDisembark" ,"Person Disembark"), true ),
        ...
        new Code(STATUS_DUTY_ON            , "DUTY_ON"      , I18N.getString(StatusCodes.class,"StatusCodes.dutyOn"          ,"Duty On"         )       ),
        new Code(STATUS_DUTY_OFF           , "DUTY_OFF"     , I18N.getString(StatusCodes.class,"StatusCodes.dutyOff"         ,"Duty Off"        )       ),
        new Code(STATUS_PANIC_ON           , "PANIC_ON"     , I18N.getString(StatusCodes.class,"StatusCodes.panicOn"         ,"Panic"           ), true ),
        new Code(STATUS_PANIC_OFF          , "PANIC_OFF"    , I18N.getString(StatusCodes.class,"StatusCodes.panicOff"        ,"Panic Off"       ), true ),
        new Code(STATUS_ALARM_ON           , "ALARM_ON"     , I18N.getString(StatusCodes.class,"StatusCodes.alarmOn"         ,"Alarm"           ), true ),
        new Code(STATUS_ALARM_OFF          , "ALARM_OFF"    , I18N.getString(StatusCodes.class,"StatusCodes.alarmOff"        ,"Alarm Off"       ), true ),
        new Code(STATUS_ASSIST_ON          , "ASSIST_ON"    , I18N.getString(StatusCodes.class,"StatusCodes.assistOn"        ,"Assist"          ), true ),
        new Code(STATUS_ASSIST_OFF         , "ASSIST_OFF"   , I18N.getString(StatusCodes.class,"StatusCodes.assistOff"       ,"Assist Off"      ), true ),
        new Code(STATUS_MEDICAL_ON         , "MEDICAL_ON"   , I18N.getString(StatusCodes.class,"StatusCodes.medicalOn"       ,"Medical"         ), true ),
        new Code(STATUS_MEDICAL_OFF        , "MEDICAL_OFF"  , I18N.getString(StatusCodes.class,"StatusCodes.medicalOff"      ,"Medical Off"     ), true ),
        new Code(STATUS_TOWING_START       , "TOW_START"    , I18N.getString(StatusCodes.class,"StatusCodes.towStart"        ,"Tow"             ), true ),
        new Code(STATUS_TOWING_STOP        , "TOW_STOP"     , I18N.getString(StatusCodes.class,"StatusCodes.towStop"         ,"Tow Stop"        ), true ),
        new Code(STATUS_INTRUSION_ON       , "INTRUSION_ON" , I18N.getString(StatusCodes.class,"StatusCodes.intrusionOn"     ,"Intrusion"       ), true ),
        new Code(STATUS_INTRUSION_OFF      , "INTRUSION_OFF", I18N.getString(StatusCodes.class,"StatusCodes.intrusionOff"    ,"Intrusion Off"   ), true ),
        new Code(STATUS_BREACH_ON          , "BREACH_ON"    , I18N.getString(StatusCodes.class,"StatusCodes.breachOn"        ,"Breach"          ), true ),
        new Code(STATUS_BREACH_OFF         , "BREACH_OFF"   , I18N.getString(StatusCodes.class,"StatusCodes.breachOff"       ,"Breach Off"      ), true ),
        new Code(STATUS_VIBRATION_ON       , "VIBRATION_ON" , I18N.getString(StatusCodes.class,"StatusCodes.vibrationOn"     ,"Vibration"       ), true ),
        new Code(STATUS_VIBRATION_OFF      , "VIBRATION_OFF", I18N.getString(StatusCodes.class,"StatusCodes.vibrationOff"    ,"Vibration Off"   ), true ),
        new Code(STATUS_PTO_ON             , "PTO_ON"       , I18N.getString(StatusCodes.class,"StatusCodes.ptoOn"           ,"PTO On"          )       ),
        new Code(STATUS_PTO_OFF            , "PTO_OFF"      , I18N.getString(StatusCodes.class,"StatusCodes.ptoOff"          ,"PTO Off"         )       ),

        new Code(STATUS_CARJACK_DISABLED   , "CARJACK_DISAB", I18N.getString(StatusCodes.class,"StatusCodes.carjack.disabled","Carjack Disable" )       ),
        new Code(STATUS_CARJACK_ENABLED    , "CARJACK_ENABL", I18N.getString(StatusCodes.class,"StatusCodes.carjack.enabled" ,"Carjack Enable"  )       ),
        new Code(STATUS_CARJACK_STANDBY    , "CARJACK_STDBY", I18N.getString(StatusCodes.class,"StatusCodes.carjack.standby" ,"Carjack StandBy" )       ),
        new Code(STATUS_CARJACK_ARMED      , "CARJACK_ARMED", I18N.getString(StatusCodes.class,"StatusCodes.carjack.armed"   ,"Carjack Armed"   ), true ),
        new Code(STATUS_CARJACK_TRIGGERED  , "CARJACK_TRIGG", I18N.getString(StatusCodes.class,"StatusCodes.carjack.trigger" ,"Carjack Trigger" ), true ),
        new Code(STATUS_CARJACK_CANCELLED  , "CARJACK_CANCL", I18N.getString(StatusCodes.class,"StatusCodes.carjack.cancel"  ,"Carjack Cancel"  ), true ),
        ...
        new Code(STATUS_LOW_FUEL           , "FUEL.LOW"     , I18N.getString(StatusCodes.class,"StatusCodes.fuelLow"         ,"FuelLow"         ), true ),
        ...
        new Code(STATUS_POWER_ALARM        , "POWERALARM"   , I18N.getString(StatusCodes.class,"StatusCodes.powerAlarm"      ,"PowerAlarm"      ), true ),
        ...
        new Code(STATUS_GPS_ANTENNA_OPEN   , "GPS.ANT.OPEN" , I18N.getString(StatusCodes.class,"StatusCodes.gpsAntennaOpen"  ,"GPSAntOpen"      ), true ),
        new Code(STATUS_GPS_ANTENNA_SHORT  , "GPS.ANT.SHORT", I18N.getString(StatusCodes.class,"StatusCodes.gpsAntennaShort" ,"GPSAntShort"     ), true ),
