...
//     -Property key "groupInfo.deviceLisSortBy" change to "groupInfo.deviceListSortBy".
// ----------------------------------------------------------------------------
    ...
    **/
    public SendMail.SmtpProperties getSmtpProperties()
    {
        if (this.smtpProperties == null) {
            RTProperties rtp = this.getRTProperties(); // backed by Domain properties
            this.smtpProperties = new SendMail.SmtpProperties(rtp);
        }
