...
public class Payload
{
    ...
    **/
    ...
    /**
    *** Calculate/Return CRC for specified offset/length
    ...
    **/
    public int calcCrcCCITT(int bOfs, int bLen)
    {
        ...
        if ((bOfs < 0) || (bOfs > this.size)) {
            return 0;
        } else {
            int ofs = (bOfs <= 0)? 0 : (bOfs >= this.size)? this.size : bOfs;
            int len = ((bLen >= 0) && (bLen <= (this.size-ofs)))? bLen : (this.size-ofs);
