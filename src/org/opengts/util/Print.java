...
public class Print
{
    ...
    **/
    protected static void _logStackTrace(int level, int frame, String msg, Throwable t)
    {
        ...
        try {
            PrintStream out = Print.openLogFile(); // does not return null
    ...
    **/
    protected static PrintStream openLogFile()
    {
        ...
        synchronized (Print.logLock) {
            ...
            if (Print.openLogFile_recursion > 0) {
            ...
            try {
                ...
                for (;;) { // single-pass loop
                    ...
                    if (Print.logOutput != null) {
                        out = Print.logOutput; // previously opened PrintStream
                    ...
                    if (logFile == null) {
                        ...
                        out = Print._getSystemErr(); // stderr
                        break havePrintStream; // exit loop
                    }
